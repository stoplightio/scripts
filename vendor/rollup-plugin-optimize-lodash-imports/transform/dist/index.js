  ...
  estree_walker_1.walk(ast, {
    enter(node) {
      ...
      if (guards_1.isImportSpecifierArray(node.specifiers)) {
        ...
        warn(
          `Detected a default lodash or lodash/fp import within ${id} on line ${(_c = (_b = (_a = node.loc) === null || _a === void 0 ? void 0 : _a.start) === null || _b === void 0 ? void 0 : _b.line) !== null && _c !== void 0 ? _c : 'unknown'}.\nThis import cannot be optimized by optimize-lodash-imports.`,
        );
      }
    },
  });
